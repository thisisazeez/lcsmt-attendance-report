...
urlpatterns = [
    ...
    path('course_registration_save/', StudentViews.course_registration_save, name="course_registration_save"),
    path('manage_course_registration/', StudentViews.manage_course_registration, name="manage_course_registration"),
